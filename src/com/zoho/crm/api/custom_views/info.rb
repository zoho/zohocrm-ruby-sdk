...
module CustomViews
  class Info
    ...
    def default
      ...
      # @param default [String] A String

    def default=(default)
      if default!=nil and !default.is_a? String
        raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: default EXPECTED TYPE: String', nil, nil)
      end
      @default = default
