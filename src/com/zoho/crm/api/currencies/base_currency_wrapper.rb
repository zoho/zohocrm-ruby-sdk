...
module Currencies
  class BaseCurrencyWrapper
    ...
    def base_currency
      ...
      # @param base_currency [Currency] An instance of Currency

    def base_currency=(base_currency)
      if base_currency!=nil and !base_currency.is_a? Currency
        raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: base_currency EXPECTED TYPE: Currency', nil, nil)
      end
